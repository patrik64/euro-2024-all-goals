...
declare module '$env/static/private' {
	...
	export const npm_package_devDependencies__rgossiaux_svelte_heroicons: string;
	...
	export const npm_package_devDependencies_svelte_youtube_embed: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		TERM: string;
		USERNAME: string;
		npm_package_devDependencies__rgossiaux_svelte_heroicons: string;
		...
		npm_package_devDependencies_svelte_youtube_embed: string;
		LC_NAME: string;
