...
<div class="max-w-7xl mx-auto py-8 sm:py-16 sm:px-6 lg:px-8">
  ...
  <div>
    <ul class="py-6 mx-4 lg:m-auto grid grid-cols-2 gap-y-8 sm:grid-cols-4 md:gap-x-6 lg:max-w-3xl lg:gap-x-8 lg:gap-y-8 xl:grid-cols-4">
  ...
  <div>
    <ul class="py-6 mx-4 lg:m-auto grid grid-cols-2 gap-y-8 sm:grid-cols-4 md:gap-x-6 lg:max-w-6xl lg:gap-x-8 lg:gap-y-8 xl:grid-cols-6">
      {#each round3 as game}
        <li>
          <div class="w-[10rem] md:w-[11rem] whitespace-nowrap bg-white lg:mx-4 mt-4 select-none cursor-pointer rounded-lg shadow-lg hover:bg-tertiary-500 hover:border-gray-700 transition duration-500 ease-in-out">
            <a href={`/${game.id}`}>
